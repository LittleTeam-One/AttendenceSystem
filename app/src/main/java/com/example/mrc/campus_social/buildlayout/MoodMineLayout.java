...
public class MoodMineLayout extends BaseFrameLayoutCard implements TalkItemAdapter.OnItemClickListener {
    ...
    public MoodMineLayout(@NonNull Context context) {
        this(context, null);
    }

    public MoodMineLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MoodMineLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public MoodMineLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
