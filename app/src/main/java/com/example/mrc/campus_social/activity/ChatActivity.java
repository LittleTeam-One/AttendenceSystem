...
import com.example.mrc.campus_social.adapter.ChatLogRecyclerViewAdapter;
...
public class ChatActivity extends BaseActivity implements View.OnClickListener, TextWatcher,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp = mContext.getSharedPreferences(CampusSocialSystemApplication.SHARED_PREF,0);
        phoneNumber = sp.getString(CampusSocialSystemApplication.USER_PHONE,"");
